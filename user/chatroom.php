...
<?php
	...
	$chatq=mysqli_query($lnk,"select * from chatroom where chatroomid='$id'");
	$chatrow=mysqli_fetch_array($chatq);
	
	$cmem=mysqli_query($lnk,"select * from chat_member where chatroomid='$id'");
?>
<body>
	...
	function displayChat(){
		...
		$.ajax({
			...
			data:{
				id: id,
				fetch: 1,
				password:"<?php echo h1($_POST['chat_pass']); ?>"
			},
