        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<center><strong><span style="font-size: 15px;">Username: <?php echo h1($user); ?></span></strong></center>
                </div> 
				</div>
            ...
            <div class="modal-content">
				...
				<form method="POST" action="update_account.php">
					...
					<div class="form-group input-group">
						...
						<input type="text" style="width:350px;" class="form-control" name="mname" value="<?php echo h1($srow['uname']); ?>">
					</div>
					<div class="form-group input-group">
						<span class="input-group-addon" style="width:150px;">Username:</span>
						<input type="text" style="width:350px;" class="form-control" name="musername" value="<?php echo h1($srow['username']); ?>">
					</div>
					<div class="form-group input-group">
						<span class="input-group-addon" style="width:150px;">Password:</span>
						<input type="password" style="width:350px;" class="form-control" name="mpassword" value="<?php echo h1($srow['password']); ?>">
					</div>
					<hr>
